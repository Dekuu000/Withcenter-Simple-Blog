        ...
        <Modal isOpen={isOpen} onClose={onClose} title={title}>
            <div className="flex flex-col gap-4">
                <div className="flex items-start gap-4">
                    ...
                    <p className="text-gray-600 leading-relaxed pt-1">{message}</p>
                </div>
                ...
                <div className="flex justify-end gap-3 mt-4">
                    ...
                    <button
                        onClick={onConfirm}
                        disabled={isLoading}
                        className={`px-4 py-2 text-sm font-medium text-white rounded-lg focus:outline-none focus:ring-2 transition-colors disabled:opacity-50 flex items-center gap-2 ${isDangerous
