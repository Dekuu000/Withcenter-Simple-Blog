...
export default function RegisterPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 py-8">
            <div className="w-full max-w-md bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-brand-secondary/20 backdrop-blur-sm">
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 transition-all bg-gray-50/50 hover:bg-white ${isEmailInvalid
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary transition-all bg-gray-50/50 hover:bg-white pr-10"
                            ...
                            <button
                                ...
                                className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-brand-primary focus:outline-none transition-colors"
                            >
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 pr-10 transition-all bg-gray-50/50 hover:bg-white ${isPasswordMismatch
                                    ? 'border-red-300 focus:ring-red-500/50 focus:border-red-500'
                                    : 'border-gray-200 focus:ring-brand-primary/20 focus:border-brand-primary'
                                    }`}
                    ...
                    <button
                        ...
                        className="w-full bg-brand-primary text-white py-3.5 px-4 rounded-xl hover:bg-brand-dark transition-all disabled:opacity-70 disabled:cursor-not-allowed font-semibold shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 transform duration-200 mt-2"
                    >
